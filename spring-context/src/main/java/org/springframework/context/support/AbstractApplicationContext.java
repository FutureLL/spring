...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				// 这个方法在当前版本的 Spring 是没有任何方法的,空壳方法
				// 可能会在之后的版本进行扩展
				...
				// 空壳方法
				// SpringBoot 源码中: Tomcat 是在这里启动的
				/**
				 * 创建 Tomcat
				 * @see org.springframework.boot.web.servlet.context.ServletWebServerApplicationContext#onRefresh
				 * 实例化 Tomcat
				 * @see org.springframework.boot.web.embedded.tomcat.TomcatWebServer#TomcatWebServer
				 */
				onRefresh();
				...
				// 创建所有剩余的非懒加载的单例类（并invoke BeanPostProcessors）
	...
	protected void prepareRefresh() {
		...
		// earlyApplicationListeners: Local listeners registered before refresh.
	...
	protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) {
		...
		// 缓存所有的 bean definition 数据,不期望以后会改变
