...
public abstract class AbstractMessageConverterMethodProcessor extends AbstractMessageConverterMethodArgumentResolver
	...
	protected <T> void writeWithMessageConverters(@Nullable T value, MethodParameter returnType,
		...
		if (selectedMediaType != null) {
			...
			// messageConverters 会提前过滤可以处理当前请求的 HttpMessageConverter
			// 遍历循环 List<HttpMessageConverter<?>> ---> 用来处理 json ---> FastJsonHttpMessageConverter
			// SpringBoot 提供了 HttpMessageConverters(org.springframework.boot.autoconfigure.http.HttpMessageConverters)
			// 添加消息处理机制: new HttpMessageConverters(new FastJsonHttpMessageConverter());
